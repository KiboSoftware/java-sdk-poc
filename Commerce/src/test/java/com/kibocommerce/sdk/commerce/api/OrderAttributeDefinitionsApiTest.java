...
/**
 * API tests for OrderAttributeDefinitionsApi
 */
@Disabled
public class OrderAttributeDefinitionsApiTest {

    private final OrderAttributeDefinitionsApi api = new OrderAttributeDefinitionsApi();
