...
/**
 * API tests for CustomerAccountAttributeDefinitionsApi
 */
@Disabled
public class CustomerAccountAttributeDefinitionsApiTest {

    private final CustomerAccountAttributeDefinitionsApi api = new CustomerAccountAttributeDefinitionsApi();
